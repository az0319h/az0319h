    ...
    <div className="z-0 pl-25 relative h-168.75">
      ...
      <div className="bg-bg-300 max-w-215 w-full absolute h-90 right-0 bottom-0">
        ...
        <div className="h-5/10 p-4">
          <ul className=" pt-6 md:pt-8 grid grid-cols-2 md:grid-cols-4 max-w-191.25 md:mx-auto  gap-y-6 [&_li]:flex  [&_li]:gap-1.5 [&_li]:flex-col [&_li]:justify-center  [&_li]:items-center [&_li>h4]:text-14-medium [&_li>span]:text-14-semibold">
            <li>
